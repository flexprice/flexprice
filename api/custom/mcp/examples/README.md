...
Copy the relevant snippet into your editor's MCP config. Replace `YOUR_API_KEY` with your key from [app.flexprice.io](https://app.flexprice.io). See the main [MCP README](../README.md) for full setup instructions.
