#!/usr/bin/env python3
"""
FlexPrice Python SDK - Local SDK tests (unpublished SDK from api/python).
Run from api/tests/python: python test_local_sdk.py
Requires: FLEXPRICE_API_KEY, FLEXPRICE_API_HOST. Build SDK first: make sdk-all
"""
...
# Add api/python to path to import the locally generated SDK (api/tests/python -> api)
_api_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
sys.path.insert(0, os.path.join(_api_dir, 'python'))
