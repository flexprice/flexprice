                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SyncStripeUsageRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.SyncStripeUsageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "dto.SyncStripeUsageRequest": {
            ...
            "properties": {
                ...
                "meter_id": {
                    "type": "string",
                    "example": "d62e8435-ecf2-43cc-9f9f-5589a736ccf7"
                },
                "start_time": {
                    "type": "string",
                ...
                "stripe_subscription_item_id": {
                    "type": "string",
                    "example": "sub_item_123"
                }
            }
        },
        "dto.SyncStripeUsageResponse": {
            "type": "object",
            "properties": {
                "run_id": {
                    "type": "string"
