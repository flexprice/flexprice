...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/IntegrationConfigResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ListEntityIntegrationMappingsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/wallets/{id}/balance/real-time": {
            "get": {
                ...
                "description": "Use when displaying or checking current wallet balance (e.g. before charging or in a portal). Supports optional expand for credits breakdown and from_cache.\nReturns the real-time wallet balance. On transient backend failure\nthe endpoint falls back to the last cached balance (response\nincludes ` + "`" + `is_cached_fallback=true` + "`" + `). A 5xx is only returned when\nno cached balance is available to serve.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "IntegrationConfigResponse": {
            ...
            "properties": {
                "integrations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/IntegrationConfigEntry"
                    }
                }
            }
        },
        ...
        "SubModifyTrialEndRequest": {
            ...
            "properties": {
                "action": {
                    "description": "Action is \"immediate\" or \"scheduled_date\".",
                    "allOf": [
                        {
                            "$ref": "#/definitions/TrialEndAction"
                        }
                    ]
                },
                "new_trial_end": {
