...
func (cga *CreditGrantApplication) String() string {
	...
	builder.WriteString(cga.AppliedAt.Format(time.ANSIC))
	builder.WriteString(", ")
	...
	builder.WriteString(cga.FailureReason)
	builder.WriteString(", ")
	builder.WriteString("next_retry_at=")
	builder.WriteString(cga.NextRetryAt.Format(time.ANSIC))
	builder.WriteString(", ")
