...
func (cgac *CreditGrantApplicationCreate) check() error {
	...
	if _, ok := cgac.mutation.AppliedAt(); !ok {
		return &ValidationError{Name: "applied_at", err: errors.New(`ent: missing required field "CreditGrantApplication.applied_at"`)}
	}
	...
	if _, ok := cgac.mutation.ProrationFactor(); !ok {
		return &ValidationError{Name: "proration_factor", err: errors.New(`ent: missing required field "CreditGrantApplication.proration_factor"`)}
	}
	if _, ok := cgac.mutation.FullPeriodAmount(); !ok {
		return &ValidationError{Name: "full_period_amount", err: errors.New(`ent: missing required field "CreditGrantApplication.full_period_amount"`)}
	}
	...
	if _, ok := cgac.mutation.FailureReason(); !ok {
		return &ValidationError{Name: "failure_reason", err: errors.New(`ent: missing required field "CreditGrantApplication.failure_reason"`)}
	}
	if _, ok := cgac.mutation.NextRetryAt(); !ok {
		return &ValidationError{Name: "next_retry_at", err: errors.New(`ent: missing required field "CreditGrantApplication.next_retry_at"`)}
	}
	if _, ok := cgac.mutation.Metadata(); !ok {
		return &ValidationError{Name: "metadata", err: errors.New(`ent: missing required field "CreditGrantApplication.metadata"`)}
	}
	return nil
}
