...
func (iec *IntegrationEntityCreate) SetEntityType(s string) *IntegrationEntityCreate {
	iec.mutation.SetEntityType(s)
	return iec
}
...
func (iec *IntegrationEntityCreate) SetProviderType(s string) *IntegrationEntityCreate {
	iec.mutation.SetProviderType(s)
	return iec
}
...
func (iec *IntegrationEntityCreate) SetSyncStatus(s string) *IntegrationEntityCreate {
	iec.mutation.SetSyncStatus(s)
	return iec
}

// SetNillableSyncStatus sets the "sync_status" field if the given value is not nil.
func (iec *IntegrationEntityCreate) SetNillableSyncStatus(s *string) *IntegrationEntityCreate {
	if s != nil {
		iec.SetSyncStatus(*s)
	}
	return iec
