...
const (
	// Label holds the string label denoting the meterprovidermapping type in the database.
	Label = "meter_provider_mapping"
	...
	// FieldProviderMeterID holds the string denoting the provider_meter_id field in the database.
	FieldProviderMeterID = "provider_meter_id"
	...
	// Table holds the table name of the meterprovidermapping in the database.
	Table = "meter_provider_mappings"
)

// Columns holds all SQL columns for meterprovidermapping fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldStatus,
...
var (
	...
	// ProviderMeterIDValidator is a validator for the "provider_meter_id" field. It is called by the builders before save.
	ProviderMeterIDValidator func(string) error
	// DefaultSyncEnabled holds the default value on creation for the "sync_enabled" field.
	DefaultSyncEnabled bool
)

// OrderOption defines the ordering options for the MeterProviderMapping queries.
...
// ByProviderMeterID orders the results by the provider_meter_id field.
func ByProviderMeterID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldProviderMeterID, opts...).ToFunc()
}
