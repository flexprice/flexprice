...
var (
	...
	InvoicesColumns = []*schema.Column{
		...
		{Name: "subtotal", Type: field.TypeOther, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "total", Type: field.TypeOther, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
