...
var (
	...
	IntegrationEntitiesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "integrationentity_entity_type_entity_id_provider_type",
				Unique:  true,
				Columns: []*schema.Column{IntegrationEntitiesColumns[7], IntegrationEntitiesColumns[8], IntegrationEntitiesColumns[9]},
				Annotation: &entsql.IndexAnnotation{
					Where: "status != 'deleted'",
				},
			},
			{
				Name:    "integrationentity_provider_type_provider_id",
				Unique:  false,
				Columns: []*schema.Column{IntegrationEntitiesColumns[9], IntegrationEntitiesColumns[10]},
				Annotation: &entsql.IndexAnnotation{
					Where: "status != 'deleted'",
				},
			},
			{
				Name:    "integrationentity_sync_status",
				Unique:  false,
				Columns: []*schema.Column{IntegrationEntitiesColumns[11]},
			},
		},
	}
