...
func (pmq *PaymentMethodQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (pmq *PaymentMethodQuery) FirstIDX(ctx context.Context) string {
...
func (pmq *PaymentMethodQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (pmq *PaymentMethodQuery) OnlyIDX(ctx context.Context) string {
...
func (pmq *PaymentMethodQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (pmq *PaymentMethodQuery) IDsX(ctx context.Context) []string {
	ids, err := pmq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pmq *PaymentMethodQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(paymentmethod.Table, paymentmethod.Columns, sqlgraph.NewFieldSpec(paymentmethod.FieldID, field.TypeString))
	_spec.From = pmq.sql
