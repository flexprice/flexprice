...
func (pmu *PaymentMethodUpdate) SetCustomerID(s string) *PaymentMethodUpdate {
	pmu.mutation.SetCustomerID(s)
	return pmu
}

// SetNillableCustomerID sets the "customer_id" field if the given value is not nil.
func (pmu *PaymentMethodUpdate) SetNillableCustomerID(s *string) *PaymentMethodUpdate {
	if s != nil {
		pmu.SetCustomerID(*s)
	}
	return pmu
...
func (pmu *PaymentMethodUpdate) check() error {
	if v, ok := pmu.mutation.CustomerID(); ok {
...
func (pmu *PaymentMethodUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pmu.mutation.CustomerID(); ok {
...
// SetCustomerID sets the "customer_id" field.
func (pmuo *PaymentMethodUpdateOne) SetCustomerID(s string) *PaymentMethodUpdateOne {
	pmuo.mutation.SetCustomerID(s)
	return pmuo
}

// SetNillableCustomerID sets the "customer_id" field if the given value is not nil.
func (pmuo *PaymentMethodUpdateOne) SetNillableCustomerID(s *string) *PaymentMethodUpdateOne {
	if s != nil {
		pmuo.SetCustomerID(*s)
	}
	return pmuo
}
...
func (pmuo *PaymentMethodUpdateOne) check() error {
	if v, ok := pmuo.mutation.CustomerID(); ok {
		if err := paymentmethod.CustomerIDValidator(v); err != nil {
			return &ValidationError{Name: "customer_id", err: fmt.Errorf(`ent: validator failed for field "PaymentMethod.customer_id": %w`, err)}
		}
	}
...
func (pmuo *PaymentMethodUpdateOne) sqlSave(ctx context.Context) (_node *PaymentMethod, err error) {
	...
	if value, ok := pmuo.mutation.CustomerID(); ok {
		_spec.SetField(paymentmethod.FieldCustomerID, field.TypeString, value)
	}
