...
func (urc *UserRoleCreate) SetTenantID(s string) *UserRoleCreate {
	urc.mutation.SetTenantID(s)
	return urc
}

// SetStatus sets the "status" field.
func (urc *UserRoleCreate) SetStatus(s string) *UserRoleCreate {
	urc.mutation.SetStatus(s)
	return urc
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableStatus(s *string) *UserRoleCreate {
	if s != nil {
		urc.SetStatus(*s)
	}
	return urc
...
func (urc *UserRoleCreate) SetRole(s string) *UserRoleCreate {
	urc.mutation.SetRole(s)
	return urc
}
...
func (urc *UserRoleCreate) check() error {
	...
	if v, ok := urc.mutation.TenantID(); ok {
		if err := userrole.TenantIDValidator(v); err != nil {
			return &ValidationError{Name: "tenant_id", err: fmt.Errorf(`ent: validator failed for field "UserRole.tenant_id": %w`, err)}
		}
	}
	if _, ok := urc.mutation.Status(); !ok {
...
func (urc *UserRoleCreate) createSpec() (*UserRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := urc.mutation.TenantID(); ok {
		_spec.SetField(userrole.FieldTenantID, field.TypeString, value)
