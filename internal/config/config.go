...
type FeatureUsageTrackingConfig struct {
	...
	RateLimit             int64  `mapstructure:"rate_limit" default:"2"`
	ConsumerGroup         string `mapstructure:"consumer_group" default:"v1_feature_usage_tracking"`
	TopicBackfill         string `mapstructure:"topic_backfill" default:"v1_feature_usage_tracking_backfill"`
	RateLimitBackfill     int64  `mapstructure:"rate_limit_backfill" default:"1"`
	ConsumerGroupBackfill string `mapstructure:"consumer_group_backfill" default:"v1_feature_usage_tracking_backfill"`
}
