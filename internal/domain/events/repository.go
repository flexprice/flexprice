...
type Repository interface {
	...
	// ListEventsByID returns unmerged events-table rows for the customer's event id, newest ingested_at first.
	ListEventsByID(ctx context.Context, externalCustomerID, eventID string, limit int) ([]*Event, error)
