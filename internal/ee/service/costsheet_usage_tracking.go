...
func (s *costsheetUsageTrackingService) RegisterHandler(router *pubsubRouter.Router, cfg *config.Configuration) {
	...
	router.AddNoPublishHandlerWithDLQ(
		...
		cfg.CostSheetUsageTracking.ConsumerGroup,
		cfg.CostSheetUsageTracking.DLQTopic,
		s.pubSub,
		s.processMessage,
		throttle.Middleware,
	)
...
func (s *costsheetUsageTrackingService) RegisterHandlerLazy(router *pubsubRouter.Router, cfg *config.Configuration) {
	...
	router.AddNoPublishHandlerWithDLQ(
		...
		cfg.CostSheetUsageTrackingLazy.ConsumerGroup,
		cfg.CostSheetUsageTrackingLazy.DLQTopic,
		s.lazyPubSub,
		s.processMessage,
		throttle.Middleware,
	)
