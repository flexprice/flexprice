...
func (r *integrationRepository) GetByEntityAndProvider(ctx context.Context, entityType, entityID, providerType string) (*domainIntegration.IntegrationEntity, error) {
	querier := r.client.Querier(ctx)
...
func (r *integrationRepository) GetByProviderID(ctx context.Context, entityType, providerID, providerType string) (*domainIntegration.IntegrationEntity, error) {
	querier := r.client.Querier(ctx)
