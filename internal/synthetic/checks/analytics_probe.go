...
func NewAnalyticsProbe(c synthetic.Client, r synthetic.Registry, runID string) *AnalyticsProbe {
	return &AnalyticsProbe{client: c, reg: r, runID: runID}
}

func (p *AnalyticsProbe) Name() string         { return "analytics-probe" }
func (p *AnalyticsProbe) Kind() synthetic.Kind { return synthetic.KindProbe }
