...
// PaddleInvoicePullSyncWorkflowInput contains the input for the Paddle invoice pull sync workflow.
type PaddleInvoicePullSyncWorkflowInput struct {
...
func (input *PaddleInvoicePullSyncWorkflowInput) Validate() error {
	if input.InvoiceID == "" {
