...
// InitializeGlobalTemporalService initializes the package-level TemporalService singleton exactly once in a thread-safe manner using the provided client, worker manager, and logger.
...
// GetGlobalTemporalService returns the package's singleton Temporal service.
// If the service has not been initialized via InitializeGlobalTemporalService, it returns nil.
