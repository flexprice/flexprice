...
const (
	...
	// InvoiceBillingReasonSubscriptionCancellation indicates invoice is for subscription cancellation
	InvoiceBillingReasonSubscriptionCancellation InvoiceBillingReason = "SUBSCRIPTION_CANCELLATION"
